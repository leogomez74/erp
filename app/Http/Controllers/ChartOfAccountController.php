...
class ChartOfAccountController extends Controller
{
    ...
    public function create(): View
    {
        ...
        $types->prepend('--', 0);
        $currencies = \DB::table('currencies')->where('created_by', \Auth::user()->creatorId())->get()->pluck('name', 'id');
        $currencies->prepend('--', '');
    ...
    public function edit(ChartOfAccount $chartOfAccount): View
    {
        ...
        return view('chartOfAccount.edit', compact('chartOfAccount', 'types', 'currencies'));
    }
    ...
    public function update(Request $request, ChartOfAccount $chartOfAccount)
    {
        if (\Auth::user()->can('edit chart of account')) {
            ...
            $chartOfAccount->currency = $request->currency;
