                    ...
                    foreach ($decode_content as $key => $value) {
                        ...
                        if ($key == 'logo') {
                            ...
                            if ($content_type == 'new_tab') {
                                ...
                                $value[] = $sys_data;
                                $data['system'] = $value;
                            } elseif ($content_type == 'update_tab_content') {
                                $system_data = [];
                            ...
                            } elseif ($content_type == 'new_tab_content') {
                                $system_inner_data = [];
                                foreach ($value as $key => $sys_value) {
                                    if ($sys_value->id == $system_element_id) {
                                        $no = 1;
                            ...
                            } elseif ($content_type == 'remove_element') {
                                foreach ($value as $key => $sys_value) {
                                    if ($sys_value->id == $system_element_id) {
                                    } else {
                                        $system_data[] = $sys_value;
                            ...
                            } elseif ($content_type == 'remove_element_data') {
                                $system_data = [];
                                foreach ($value as $key => $sys_value) {
                                    $system_inner_data = [];
                                    if ($sys_value->id == $system_element_id) {
                            ...
                            } elseif ($content_type == 'new_section') {
                                $no = 1;
                                $data_text = [];
