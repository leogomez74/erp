...
@push('script-page')
    ...
    <script>
        ...
        $(document).on('change', '#customer', function () {
            ...
            const format_date = moment(due_date,'YYYY-MM-DD');
            console.log(due_date);
            $.ajax({
                url: "{{ route('invoice.customer2', ':id') }}".replace(':id', id),
                type: "GET",
                dataType: "json",
                success: function (response) {
                    ...
                    if (response.pay_type==2) {
                        var  new_date= moment(format_date).add(8,"days").format("YYYY-MM-DD");
                        $('#due_date').val(new_date);
                    }
                    if (response.pay_type==3) {
                        var  new_date= moment(format_date).add(15,"days").format("YYYY-MM-DD");
                        $('#due_date').val(new_date);
                    }
                    if (response.pay_type==4) {
                        var  new_date= moment(format_date).add(30,"days").format("YYYY-MM-DD");
                        $('#due_date').val(new_date);
                    }
                }
            });
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            {{Form::date('due_date',\Carbon\Carbon::now(),array('class'=>'form-control','required'=>'required'))}}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        {{ Form::label('category_id', __('Chart of Accounts'),['class'=>'form-label']) }}
                    ...
                    <div class="table-responsive">
                        <table class="table  mb-0 table-custom-style" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group price-input input-group search-form">
                                        {{ Form::text('price','', array('class' => 'form-control price readonly','required'=>'required','placeholder'=>__('Price'),'required'=>'required','readonly')) }}
