    ...
    <script>
        $(document).on('click', '#shipping', function () {
            ...
            $.ajax({
                url: url,
                type: 'get',
                data: {/var/www/html/product/rajodiya/erpgo_new_theme/main/erpgo_saas/main_file
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-4">
                                ...
                                @if($invoice->status==0)
                                    @can('send bill')
                                       ...
                                       <!-- Button created by ahixel rojas at 22/09/2022 17:30 to mark as sent-->
                                        <a href="{{ route('invoice.mark-sent',$invoice->id) }}" class="btn btn-sm btn-warning" data-bs-toggle="tooltip" data-original-title="{{__('Mark Sent')}}"><i class="ti ti-check mr-2"></i>{{__('Mark Sent')}}</a>
                                    @endcan
                                @endif
                            </div>
                            <div class="col-md-6 col-lg-4 col-xl-4">
                        ...
                        <table class="table ">
                            ...
                            @forelse($invoice->payments as $key =>$payment)
                                ...
                                <tr>
                                    ...
                                    <td>{{!empty($payment->bankAccount)?$payment->bankAccount->name:'--'}}</td>
