    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    {{Form::text('tax_number',null,array('class'=>'form-control','required'=>'required'))}}
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    {{Form::select('client_type', $client_type, null, ['class' => 'form-control select'])}}
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    {{Form::select('pay_type', $pay_type, null, ['class' => 'form-control select']) }}
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <div class="input-group">
                    {{Form::textarea('billing_address',null,array('class'=>'form-control','required'=>'required','rows'=>3))}}
                </div>
            </div>
        </div>
    </div>
