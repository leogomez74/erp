...
@section('content')
    <div class="row">
        ...
        <div class="col-md-4 col-lg-4 col-xl-4">
            <div class="card pb-0 customer-detail-box vendor_card">
                <div class="card-body">
                    {{--View modified  by ahixel rojas at 22/09/2022 19:00 view change to show pay info--}}
                    <h5 class="card-title">{{__('Pay Info')}}</h5>
                    <p class="card-text mb-0">{{$vendor->account_number}}</p>
                    <p class="card-text mb-0">{{$vendor->pay_type==0?'Cash':'On Credit'}}</p>
