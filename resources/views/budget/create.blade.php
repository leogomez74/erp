...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{__('Create Budget Planner')}}</li>
@endsection
@push('script-page')
                    ...
                    <tr>
                        ...
                        @foreach ($assetsproduct as $productService)
                            <tr>
                                ...
                                @foreach($monthList as $month)
                                    <td>
                                        <input type="number" class="form-control pl-1 pr-1 assets_data {{$month}}_assets" data-month="{{$month}}" name="assets[{{$productService->id}}][{{$month}}]" value="0" id="assets_data_{{$month}}">
                                    </td>
                                @endforeach
                    ...
                    <tr>
                        ...
                        @foreach ($liabilitieproduct as $productService)
                            <tr>
                                ...
                                @foreach($monthList as $month)
                                    <td>
                                        <input type="number" class="form-control pl-1 pr-1 liabilitie_data {{$month}}_liabilitie" data-month="{{$month}}" name="liabilitie[{{$productService->id}}][{{$month}}]" value="0" id="liabilitie_data_{{$month}}">
                                    </td>
                                @endforeach
                    ...
                    <tr>
                        ...
                        @foreach ($equityproduct as $productService)
                            <tr>
                                ...
                                @foreach($monthList as $month)
                                    <td>
                                        <input type="number" class="form-control pl-1 pr-1 equity_data {{$month}}_equity" data-month="{{$month}}" name="equity[{{$productService->id}}][{{$month}}]" value="0" id="equity_data_{{$month}}">
                                    </td>
                                @endforeach
                    ...
                    <table class="table mb-0" id="dataTable-manual">
                        ...
                        @foreach ($assetsproduct as $productService)
                            <tr>
                                ...
                                @endforeach
                                <td class="text-end totalAssets text-dark">
                                    0.00
                                </td>
                            </tr>
                        @endforeach
                    ...
                    <tr>
                        ...
                        @foreach ($liabilitieproduct as $productService)
                            <tr>
                                ...
                                @endforeach
                                <td class="text-end totalLiabilitie text-dark">
                                    0.00
                                </td>
                            </tr>
                        @endforeach
                    ...
                    <tr>
                        ...
                        @foreach ($equityproduct as $productService)
                            <tr>
                                ...
                                @endforeach
                                <td class="text-end totalEquity text-dark">
                                    0.00
                                </td>
                            </tr>
                        @endforeach
