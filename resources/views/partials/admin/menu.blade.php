                    ...
                    <div class="navbar-content">
                        @if(\Auth::user()->type != 'client')
                            <ul class="dash-navbar">
                                <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'help')?'active':''}}">
                                    <a href="{{ url('help') }}" class="dash-link">
                                        <span class="dash-micon"><i class="ti ti-help"></i></span><span
                                                class="dash-mtext">{{__('Use guide')}}</span>
                                    </a>
                                </li>
                            <!--------------------- Start Dashboard ----------------------------------->
                                            ...
                                            @if(\Auth::user()->show_account() == 1 && Gate::check('show account dashboard'))
                                                ...
                                                @can('show account dashboard')
                                                    <li class="dash-item {{ ( Request::segment(1) == null || Request::segment(1) == 'account-dashboard') ? ' active' : '' }}">
                                                        <a class="dash-link"
                                                           href="{{route('dashboard')}}">{{__('Accounting')}}</a>
                                                    </li>
                                                    @endcan
                                                ...
                                                @if(\Auth::user()->show_hrm() == 1)
                                                    ...
                                                    @can('show hrm dashboard')
                                                        <li class="dash-item {{ (\Request::route()->getName()=='hrm.dashboard') ? ' active' : '' }}">
                                                            <a class="dash-link"
                                                               href="{{route('hrm.dashboard')}}">{{__(' HRM')}}</a>
                                                        </li>
                                                        @endcan
                            ...
                            <!--------------------- Start User Managaement System ----------------------------------->
                                @if(\Auth::user()->type!='super admin' &&( Gate::check('manage user') || Gate::check('manage role') || Gate::check('manage client')))
                                    <li class="dash-item dash-hasmenu">
                                        <a href="#!"
                                           class="dash-link {{ (Request::segment(1) == 'users' || Request::segment(1) == 'roles' || Request::segment(1) == 'clients')?' active dash-trigger':''}}"
                                        ><span class="dash-micon"><i class="ti ti-users"></i></span
                                            ><span class="dash-mtext">{{__('User Management')}}</span
                                            ><span class="dash-arrow"><i data-feather="chevron-right"></i></span
                                            ></a>
                                        <ul class="dash-submenu">
                                            @if(\Auth::user()->type=='company'  && \Auth::user()->created_id==0 &&  \Auth::user()->created_by==1)
                                                @can('manage user')
                                            ...
                                            @can('manage client')
                                                <li class="dash-item {{ (Request::route()->getName() == 'clients.index' || Request::segment(1) == 'clients' || Request::route()->getName() == 'clients.edit') ? ' active' : '' }}">
                                                    <a class="dash-link"
                                                       href="{{ route('clients.index') }}">{{__('Client Login')}}</a>
                                                </li>
                                            @endcan
                                    ...
                                    <li class="dash-item dash-hasmenu">
                                        <a href="#!" class="dash-link ">
                                            <span class="dash-micon"><i class="ti ti-shopping-cart"></i></span><span
                                                    class="dash-mtext">{{__('Products System')}}</span><span
                                                    class="dash-arrow">
                                        <i data-feather="chevron-right"></i></span>
                                        </a>
                                        <ul class="dash-submenu">
                                            ...
                                            @if(Gate::check('manage product & service'))
                                                <li class="dash-item {{ (Request::segment(1) == 'productstock')?'active':''}}">
                                                    <a href="{{ route('productstock.index') }}"
                                                       class="dash-link">{{__('Manage Product Stock')}}
                                                    </a>
                                                </li>
                                            @endif
                                            @if(Gate::check('manage product & service'))
                                ...
                                @if(\Auth::user()->show_account() == 1)
                                    @if( Gate::check('manage customer') || Gate::check('manage vender') || Gate::check('manage customer') || Gate::check('manage vender') ||
                                        ...
                                        {{ (Request::route()->getName() == 'print-setting' || Request::segment(1) == 'customer' ||
                                            ...
                                            <a href="#!" class="dash-link"><span class="dash-micon"><i
                                                            class="ti ti-box"></i></span><span class="dash-mtext">{{__('Accounting System ')}}
                                            ...
                                            <ul class="dash-submenu">
                                                ...
                                                @if( Gate::check('manage invoice') ||  Gate::check('manage revenue') ||  Gate::check('manage credit note')||  Gate::check('manage proposal'))
                                                ...
                                                @endif
                                                <li class="dash-item dash-hasmenu {{(Request::segment(1) == 'charges.request.index' || Request::segment(1) == 'charges.index')? 'active dash-trigger' :''}}">
                                                    <a class="dash-link" href="#">{{__('Collections')}}<span
                                                                class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                                    <ul class="dash-submenu">
                                                        @if(Gate::check('manage charges'))
                                                            <li class="dash-item {{ (Request::segment(1) == 'charges.request.index')?'active':''}}">
                                                                <a class="dash-link"
                                                                   href="{{route('charges.request.index')}}">{{__('Charges Request')}}</a>
                                                            </li>
                                                        @endif
                                                        @if(Gate::check('manage charges'))
                                                            <li class="dash-item {{ (Request::segment(1) == 'charges.index')?'active':''}}">
                                                                <a class="dash-link"
                                                                   href="{{route('charges.index')}}">{{__('Charges Pending')}}</a>
                                                            </li>
                                                        @endif
                                                    </ul>
                                                </li>
                                                    ...
                                                    <li class="dash-item dash-hasmenu
                                                        ...
                                                        <a class="dash-link" href="#">{{__('Reports')}}<span
                                                                    class="dash-arrow"><i
                                                                        data-feather="chevron-right"></i></span></a>
                                                        <ul class="dash-submenu">
                                                            <li class="dash-item {{ (Request::route()->getName() == 'report.account' ) ? ' active' : '' }}">
                                                                <a class="dash-link"
                                                                   href="{{route('report.account')}}">{{__('Accounts')}}</a>
                                                            </li>
                                                            <li class="dash-item {{ (Request::route()->getName() == 'report.account2' ) ? ' active' : '' }}">
                                                                <a class="dash-link"
                                                                   href="{{route('report.account2')}}">{{__('Accounts 2')}}</a>
                                                            </li>
                                                            @can('expense report')
                                                            ...
                                                            @can('statement report')
                                                                ...
                                                                <li class="dash-item {{ (Request::route()->getName() == 'report.accountbalances') ? ' active' : '' }}">
                                                                    <a class="dash-link"
                                                                       href="{{route('report.accountbalances')}}">{{__('Account Balances')}}</a>
                                                                </li>
                                                            @endcan
                                                            @can('invoice report')
                                                            ...
                                                            <!--<li class="dash-item {{ (Request::route()->getName() == 'report.profit.loss.summary' ) ? ' active' : '' }}">
                                                                ...
                                                                <li class="dash-item {{ (Request::route()->getName() == 'report.profit.loss.summary' ) ? ' active' : '' }}">
                                                                    <a class="dash-link"
                                                                       href="{{route('report.profit.loss.total')}}">{{__('Profit & Loss')}}</a>
                                                                </li>
                                                            @endcan
                                                ...
                                                @if( Gate::check('manage goal'))
                                                    <li class="dash-item dash-hasmenu {{(Request::segment(1) == 'budget' || Request::segment(1) == 'goal' )? 'active dash-trigger' :''}}">
                                                        <a class="dash-link" href="#">{{__('Tools')}}<span
                                                                    class="dash-arrow"><i
                                                                        data-feather="chevron-right"></i></span></a>
                                                        <ul class="dash-submenu">
                                                ...
                                                @if( Gate::check('manage constant tax')|| Gate::check('manage constant category')||Gate::check('manage constant unit') ||Gate::check('manage constant payment method') ||Gate::check('manage constant custom field'))
                                                    <li class="dash-item dash-hasmenu {{(Request::segment(1) == 'taxes'  || Request::segment(1) == 'product-unit' || Request::segment(1) == 'payment-method' || Request::segment(1) == 'custom-field' || Request::segment(1) == 'chart-of-account-type')? 'active dash-trigger' :''}}">
                                                        <a class="dash-link" href="#">{{__('Settings')}}<span
                                                                    class="dash-arrow"><i
                                                                        data-feather="chevron-right"></i></span></a>
                                                        <ul class="dash-submenu">
                                                            @if(Gate::check('manage constant tax') || Gate::check('manage constant category') ||Gate::check('manage constant unit') ||Gate::check('manage constant payment method') ||Gate::check('manage constant custom field') )
                                                                <li class="dash-item {{(Request::segment(1) == 'taxes' ||  Request::segment(1) == 'product-unit' || Request::segment(1) == 'payment-method' || Request::segment(1) == 'custom-field' || Request::segment(1) == 'chart-of-account-type')? 'active dash-trigger' :''}}">
                                                                    <a class="dash-link"
                                                                       href="{{ route('taxes.index') }}">{{__('Setup')}}</a>
                                                                </li>
                                                            @endif
                                    ...
                                    @if( Gate::check('manage lead') || Gate::check('manage deal') || Gate::check('manage form builder'))
                                        ...
                                        {{ (Request::segment(1) == 'stages' || Request::segment(1) == 'labels' || Request::segment(1) == 'sources' ||
                                            ...
                                            <a href="#!" class="dash-link"><span class="dash-micon"><i
                                                        ...
                                                        class="dash-mtext">{{__('CRM System')}}</span><span
                                                        class="dash-arrow"><i
                                                            data-feather="chevron-right"></i></span></a>
                                            <ul class="dash-submenu
                                            {{ (Request::segment(1) == 'stages' || Request::segment(1) == 'labels' || Request::segment(1) == 'sources' ||
                                                        ...
                                                        <ul class="dash-submenu">
                                                            ...
                                                            @can('manage attendance')
                                                                <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'attendanceemployee') ? 'active dash-trigger' : ''}}"
                                                                    href="#navbar-attendance" data-toggle="collapse"
                                                                    role="button"
                                ...
                                @if(Gate::check('manage system settings'))
                                    <li class="dash-item dash-hasmenu {{ (Request::route()->getName() == 'systems.index') ? ' active' : '' }}">
                                        <a href="{{ route('systems.index') }}" class="dash-link">
                                            <span class="dash-micon"><i class="ti ti-settings"></i></span><span
                                                    class="dash-mtext">{{__('System Setting')}}</span>
                                        </a>
                                    </li>
                                @endif
