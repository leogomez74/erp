@php
    ...
    $companies= \App\Models\User::setCompanies();
                ...
                <li class="dropdown dash-h-item drp-company">
                    ...
                    >
                        <span class="theme-avtar">
                             <img src="{{(!empty(\Auth::user()->avatar))? asset(Storage::url("uploads/avatar/".\Auth::user()->avatar)): asset('assets/images/avatar.png')}}" class="img-fluid rounded-circle">
                           </span>
        ...
        <div class="me-auto dash-mob-drp">
            <ul class="list-unstyled">
                ...
                <li class="dropdown dash-h-item drp-company">
                    ...
                    <span class="drp-text hide-mob ">{{Str::upper((session('companies_users')===true)? $users->name:' Seleccione Compañía')}}</span>
                    <i class="ti ti-chevron-down drp-arrow nocolor hide-mob"></i>
                    ...
                    <div class="dropdown-menu dash-h-dropdown">
                        @foreach($companies as $company)
                            ...
                            <a href="{{route('change.company',$company->id)}}" class="dropdown-item  @if($company->name == $users->name) text-danger @endif">
                                <span>{{Str::upper($company->name)}}</span>
                            </a>
                        @endforeach
                    ...
                    <div class="dropdown-menu dash-h-dropdown dropdown-menu-end">
                        ...
                        <h></h>
                            @if(\Auth::user()->type=='super admin')
                                <a class="drpdown-item text-primary" href="{{route('manage.language',[isset($lang)?$lang:'en'])}}">{{ __('Manage Language ') }}</a>
                            @endif
                    </div>
                </li>
            </ul>
